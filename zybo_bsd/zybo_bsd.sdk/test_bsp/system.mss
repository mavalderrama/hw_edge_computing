...
BEGIN OS
 ...
 PARAMETER OS_VER = 1.41
 PARAMETER PROC_INSTANCE = ps7_cortexa9_0
 PARAMETER STDIN_OUT = ps7_uart_1
 PARAMETER UCOS_ETHERNET_ADDRESS = 192.168.1.200
 PARAMETER UCOS_ETHERNET_GATEWAY = 192.168.1.1
 PARAMETER UCOS_ETHERNET_INTERFACE = ps7_ethernet_0
 PARAMETER UCOS_IF_RX_BUF_NBR = 32
 PARAMETER UCOS_IF_TX_LARGE_BUF_NBR = 32
 PARAMETER UCOS_IF_TX_SMALL_BUF_NBR = 32
END


BEGIN PROCESSOR
 PARAMETER DRIVER_NAME = ucos_cpu_cortexa9
 PARAMETER DRIVER_VER = 1.41
 PARAMETER HW_INSTANCE = ps7_cortexa9_0
END


BEGIN DRIVER
 PARAMETER DRIVER_NAME = ucos_axitimer
 PARAMETER DRIVER_VER = 1.41
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = ucos_scugic
 PARAMETER DRIVER_VER = 1.41
