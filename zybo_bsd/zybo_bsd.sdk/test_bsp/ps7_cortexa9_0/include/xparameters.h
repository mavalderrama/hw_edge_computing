...
/* Definitions for driver UCOS_AXITIMER */
#define XPAR_UCOS_AXITIMER_NUM_INSTANCES 2
...
#define UCOS_ETHERNET_ADDRESS "192.168.1.200"
#define UCOS_ETHERNET_GATEWAY "192.168.1.1"
#define UCOS_ETHERNET_SUBMASK "255.255.255.0"
#define UCOS_ETHERNET_DHCP DEF_ENABLED
#define UCOS_IF_RX_BUF_NBR 32
#define UCOS_IF_TX_LARGE_BUF_NBR 32
#define UCOS_IF_TX_SMALL_BUF_NBR 32
...
#define XPAR_AXI_TIMER_0_INT_SOURCE 61

#define XPAR_AXI_TIMER_1_INT_SOURCE 62

#define NET_TASK_CFG_RX_PRIO 30
#define NET_TASK_CFG_RX_STACK_SIZE 3072
#define NET_TASK_CFG_TXDEALLOC_PRIO 6
#define NET_TASK_CFG_TXDEALLOC_STACK_SIZE 1024
