                                       ...
                                       HTTPc_KEY_VAL     **p_key_val)
{
    ...
    switch(index) {
        case 0:
            ...
            (void)Str_Copy_N(p_kvp->KeyPtr, "token", HTTPc_APP_CFG_QUERY_STR_KEY_LEN_MAX);
            (void)Str_Copy_N(p_kvp->ValPtr, "EffdQAuKX7J1AXXKnF1ErTbvpZ5ktr", HTTPc_APP_CFG_QUERY_STR_VAL_LEN_MAX);
                                  ...
                                  HTTPc_HDR         **p_hdr)
{
    ...
    p_hdr_tmp->HdrField = HTTP_HDR_FIELD_CONTENT_TYPE;
    Str_Copy_N(p_hdr_tmp->ValPtr, "application/json", HTTPc_APP_CFG_HDR_VAL_LEN_MAX);
